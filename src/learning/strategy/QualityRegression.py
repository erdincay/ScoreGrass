...
def _register_regression(x_dim, y_dim):
    return [
        ScikitBayesianRidge.ScikitBayesianRidge(
            combine_name(QualityRegression.__name__, ScikitBayesianRidge.ScikitBayesianRidge.__name__)),
        ...
        TheanetsANNs.TheanetsANNs(x_dim, y_dim, math.floor(x_dim / 2),
                                  combine_name(QualityRegression.__name__, TheanetsANNs.TheanetsANNs.__name__)),
        PyBrainANNs.PyBrainANNs(x_dim, y_dim, math.floor(x_dim / 2),
                                combine_name(QualityRegression.__name__, PyBrainANNs.PyBrainANNs.__name__))
    ]
