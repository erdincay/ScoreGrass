...
# print(image_grey)
markers = np.zeros(image_grey.shape, dtype=np.uint)
markers[image_grey < 0.3] = 1
markers[image_grey > 0.7] = 2

# print(markers)
# Run random walker algorithm
labels = random_walker(image_grey, markers, beta=10, mode='bf')
print(labels)

# Plot results
fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(8, 3.2))
ax1.imshow(image_grey, cmap='gray', interpolation='nearest')
ax1.axis('off')
